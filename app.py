...
from Almanac.Data import get_weather_data, get_frost_dates
from Almanac.Models import hw_weekly_frost_date_forecast, sarima_forecast
...
app.layout = html.Div(
    [
        ...
        html.Div(" ", style={"display": "inline-block", "padding-right": 10}),
        # Start Date Input
        dcc.Input(
            id="start-date",
            type="text",
